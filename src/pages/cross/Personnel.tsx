...
const STATUS: Record<string, { label: string; cls: string }> = {
  present:  { label: "Présent",  cls: "bg-emerald-50 dark:bg-emerald-950/30 text-emerald-700 dark:text-emerald-400" },
  absent:   { label: "Absent",   cls: "bg-rose-50 dark:bg-rose-950/30 text-rose-700 dark:text-rose-400" },
  leave:    { label: "Congé",    cls: "bg-amber-50 dark:bg-amber-950/30 text-amber-700 dark:text-amber-400" },
  late:     { label: "Retard",   cls: "bg-orange-50 dark:bg-orange-950/30 text-orange-700 dark:text-orange-400" },
  inactive: { label: "Inactif",  cls: "bg-slate-100 dark:bg-slate-800/40 text-slate-600 dark:text-slate-300" },
};
      ...
      <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        {!me ? (
          <Card className="border-amber-200 dark:border-amber-800/40 bg-amber-50/60 dark:bg-amber-950/30 shadow-sm">
            <CardContent className="p-6 text-sm text-amber-900 dark:text-amber-300">
