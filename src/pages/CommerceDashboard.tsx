  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <RevenueEvolutionChart className="lg:col-span-2" />
        ...
        <Card className="shadow-sm flex flex-col">
          ...
          {dashboard.lowStock.length > 0 && (
            <div className="p-4 border-t border-border mt-auto">
              <Link to="/app/stock" className="w-full py-2.5 text-sm font-semibold text-primary hover:bg-primary/5 rounded-xl transition-colors flex items-center justify-center gap-2">
      ...
      <Card className="shadow-sm">
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Link to="/app/ventes" className="text-sm font-medium text-primary hover:underline flex items-center gap-1">
