...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GestioPro — Gestion modulaire pour PME africaines" },
      { name: "description", content: "GestioPro : la plateforme tout-en-un pour piloter votre PME (ventes, stock, clients, finances) — adaptée à chaque secteur." },
