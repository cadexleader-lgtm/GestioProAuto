...
DROP POLICY IF EXISTS "members read" ON public.vehicle_sales;
DROP POLICY IF EXISTS "members insert" ON public.vehicle_sales;
DROP POLICY IF EXISTS "members update" ON public.vehicle_sales;
DROP POLICY IF EXISTS "managers delete" ON public.vehicle_sales;

CREATE POLICY "members read vehicle sales"
  ON public.vehicle_sales FOR SELECT TO authenticated
  USING (private.is_company_member(company_id));
CREATE POLICY "managers insert vehicle sales"
...
CREATE POLICY "managers update vehicle sales"
  ...
  WITH CHECK (private.company_role_at_least(company_id, 'manager'::public.app_role));
CREATE POLICY "managers delete vehicle sales"
  ON public.vehicle_sales FOR DELETE TO authenticated
  USING (private.company_role_at_least(company_id, 'manager'::public.app_role));

DROP POLICY IF EXISTS "members read" ON public.vehicles;
DROP POLICY IF EXISTS "members insert" ON public.vehicles;
DROP POLICY IF EXISTS "members update" ON public.vehicles;
DROP POLICY IF EXISTS "managers delete" ON public.vehicles;
...
CREATE POLICY "managers update vehicles"
  ...
  USING (private.company_role_at_least(company_id, 'manager'::public.app_role))
  WITH CHECK (private.company_role_at_least(company_id, 'manager'::public.app_role));
CREATE POLICY "managers delete vehicles"
  ON public.vehicles FOR DELETE TO authenticated
  USING (private.company_role_at_least(company_id, 'manager'::public.app_role));

DROP POLICY IF EXISTS "members read cash movements" ON public.cash_movements;
